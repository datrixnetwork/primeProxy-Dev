...
<head>
  ...
  <link rel="stylesheet" href="https://primeproxymarketing.com/plugins/fontawesome-free/css/all.min.css">
  <!-- DataTables -->
  <link rel="stylesheet" href="https://primeproxymarketing.com/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
  <link rel="stylesheet" href="https://primeproxymarketing.com/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
  <link rel="stylesheet" href="https://primeproxymarketing.com/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
  <link rel="stylesheet" href="https://primeproxymarketing.com/dist/css/adminlte.min.css">
...
<!-- jQuery -->
<script src="https://primeproxymarketing.com/plugins/jquery/jquery.min.js"></script>
<!-- Bootstrap 4 -->
<script src="https://primeproxymarketing.com/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- DataTables  & Plugins -->
<script src="https://primeproxymarketing.com/plugins/datatables/jquery.dataTables.min.js"></script>
<script src="https://primeproxymarketing.com/plugins/datatables-bs4/js/dataTables.bootstrap4.min.js"></script>
<script src="https://primeproxymarketing.com/plugins/datatables-responsive/js/dataTables.responsive.min.js"></script>
<script src="https://primeproxymarketing.com/plugins/datatables-responsive/js/responsive.bootstrap4.min.js"></script>
<script src="https://primeproxymarketing.com/plugins/datatables-buttons/js/dataTables.buttons.min.js"></script>
<script src="https://primeproxymarketing.com/plugins/datatables-buttons/js/buttons.bootstrap4.min.js"></script>
<script src="https://primeproxymarketing.com/plugins/datatables-buttons/js/buttons.html5.min.js"></script>
<script src="https://primeproxymarketing.com/plugins/datatables-buttons/js/buttons.print.min.js"></script>
...
<script>
  $(function () {
    ...
    //   var url ='http://localhost/Datrix/dtxOms/public/api/v1/orderSheet/'+sites;
      var url ='https://primeproxymarketing.com/primeProxy-Dev/public/api/v1/orderSheet/'+sites;
      var formData ={};
  ...
  function markAdminCommissionPaid(id){
    ...
    var urlToPost      = 'https://primeproxymarketing.com/primeProxy-Dev/public/api/v1/admin/orders/'+id;
    var authToken      = JSON.parse(localStorage.getItem('verificationTicket'));
    var formData = {
