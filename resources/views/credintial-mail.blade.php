                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="600" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-p20b" align="center" style="font-size:0"><a href="#" target="_blank"><img src="https://primeproxymarketing/dist/img/logo1.jpeg" alt style="display: block;" width="154"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text" align="center">
                                                                                        <p style="color: #64434a; font-size: 16px; line-height: 150%;">Username: {!! $userName !!}</p>
                                                                                        <p style="color: #64434a; font-size: 16px; line-height: 150%;">Password: {!! $pass !!}</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p20t es-p20b es-p10r es-p10l" align="center"><span class="es-button-border" style="background: #f8f3ef none repeat scroll 0% 0%;"><a href="https://www.primeproxymarketing.com/login.html" class="es-button" target="_blank" style="background: #f8f3ef none repeat scroll 0% 0%; border-color: #f8f3ef;">Log In Now</a></span></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td esdev-links-color="#999999" class="esd-block-text" align="center">
                                                                                        <p style="color: #ffffff;">You are receiving this email because you have signup at {!! $companyName !!}.</p>
                                                                                    </td>
                                                                                </tr>
